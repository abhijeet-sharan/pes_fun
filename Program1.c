...
while(1)
{
  ...
  printf("0%o\t\t", max_unsigned);//prints octal rep. of max. possible value
  printf("0\n");

  printf("Decimal(abs)\t\t\t");
  printf("%d\t\t", abs(actualvalue));//prints decimal re. absolute of input value
  printf("%d\t\t", max_unsigned);//prints decimal rep. of max. possible value
  printf("0\n");

  printf("Hexadecimal(abs)\t\t");
  printf("0x%X\t\t", abs(actualvalue));//prints hex rep. of absolute of input value
  printf("0x%X\t\t", max_unsigned);//prints octal rep. of max. possible value
  printf("0x0\n");
